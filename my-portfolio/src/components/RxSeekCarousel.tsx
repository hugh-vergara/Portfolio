...
const RxSeekCarousel: React.FC = () => {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto bg-gray-900 text-white p-6 pt-20 rounded-lg">
            ...
            {/* Description */}
            <p className="mt-4 text-center text-gray-300">{slides[current].description}</p>
        </div>
    );
};
